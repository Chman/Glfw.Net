namespace Glfw3
{
    ...
    public static partial class Glfw
    {
        ...
        public static void WindowHint(Hint hint, bool value) => glfwWindowHint((int)hint, value ? 1 : 0);
        ...
        /// <see cref="GetFramebufferSize(Window, out int, out int)"/>.</para>
        ...
        /// the <see cref="Hint.Visible"/> hint, set its position and then show it.</para>
        ...
        /// <see cref="SetWindowIcon(Window, Image)"/>.</para>
        ...
        /// created. Set the <see cref="Hint.Focused"/> hint to disable this behavior.</para>
        ...
        /// the monitor is <see cref = "Monitor.None" />, makes it windowed mode.</para>
        ...
        /// <para>When the monitor is <see cref = "Monitor.None" />, the position, width and height
        ...
        /// windowed mode window, see <see cref="SetWindowSize(Window, int, int)"/>"/>.</para>
        ...
        /// <param name="monitor">The desired monitor, or <see cref="Monitor.None"/> to set windowed
        /// mode.</param>
        ...
        /// time with <see cref="SetWindowShouldClose(Window, bool)"/>.</para>
        ...
        /// <see cref="SetMouseButtonCallback(Window, MouseButtonFunc)"/>.</para>
        /// </summary>
        /// <param name="window">The window whose callback to set.</param>
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        ...
        /// <para>If the mode is <see cref="InputMode.Cursor"/>, the value must be one of the
        /// following cursor modes:</para>
        /// <list type="bullet">
        ///     <item><see cref="CursorMode.Normal"/> makes the cursor visible and behaving
        ///     normally.</item>
        ///     <item><see cref="CursorMode.Hidden"/> makes the cursor invisible when it is over the
        ///     client area of the window but does not restrict the cursor from leaving.</item>
        ///     <item><see cref="CursorMode.Disabled"/> hides and grabs the cursor, providing
        ///     virtual and unlimited cursor movement.This is useful for implementing for example 3D
        ///     camera controls.</item>
        /// </list>
        /// <para>If the mode is <see cref="InputMode.StickyKeys"/>, the value must be either
        ...
        /// <para>If the mode is <see cref="InputMode.StickyMouseButton"/>, the value must be either
        ...
        /// <see cref="GetMouseButton(Window, int)"/> returns <see cref="InputState.Press"/> the
        ...
        public static void SetInputMode(Window window, InputMode mode, CursorMode value) => glfwSetInputMode(window.Ptr, Convert.ToInt32(mode), Convert.ToInt32(value));
        ...
        /// <para>If the key is <see cref="KeyCode.Unknown"/>, the scancode is used instead,
        ...
        /// <list type="bullet">
        ///     <item><see cref="KeyCode.Apostrophe"/></item>
        ///     <item><see cref="KeyCode.Comma"/></item>
        ///     <item><see cref="KeyCode.Minus"/></item>
        ///     <item><see cref="KeyCode.Period"/></item>
        ///     <item><see cref="KeyCode.Slash"/></item>
        ///     <item><see cref="KeyCode.SemiColon"/></item>
        ///     <item><see cref="KeyCode.Equal"/></item>
        ///     <item><see cref="KeyCode.LeftBracket"/></item>
        ///     <item><see cref="KeyCode.RightBracket"/></item>
        ///     <item><see cref="KeyCode.Backslash"/></item>
        ///     <item><see cref="KeyCode.World1"/></item>
        ///     <item><see cref="KeyCode.World2"/></item>
        ...
        ///     <item><see cref="KeyCode.NumpadDecimal"/></item>
        ///     <item><see cref="KeyCode.NumpadDivide"/></item>
        ///     <item><see cref="KeyCode.NumpadMultiply"/></item>
        ///     <item><see cref="KeyCode.NumpadSubtract"/></item>
        ///     <item><see cref="KeyCode.NumpadAdd"/></item>
        ///     <item><see cref="KeyCode.NumpadEqual"/></item>
        /// </list>
        /// </summary>
        ...
        /// <para>If the <see cref="InputMode.StickyKeys"/> input mode is enabled, this function
        ...
        /// <param name="key">The desired keyboard key. <see cref="KeyCode.Unknown"/> is not a valid
        ...
        /// <para>If the cursor is disabled (with <see cref="CursorMode.Disabled"/>) then the cursor
        ...
        /// information.</para>
        /// <para>If the cursor mode is <see cref = "CursorMode.Disabled" /> then the cursor
        ...
        /// of the window is <see cref="CursorMode.Normal"/>.</para>
        ...
        /// use the <see cref="SetCharCallback(Window, CharFunc)"/> instead.</para>
        ...
        /// not saved and so it cannot be queried with <see cref="GetKey(Window, int)"/>.</para>
        ...
        /// released, see <see cref="SetKeyCallback(Window, KeyFunc)"/> instead.</para>
        /// </summary>
        /// <param name="window">The window whose callback to set.</param>
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        ...
        /// without a context will generate a <see cref="ErrorCode.NoWindowContext"/> error.</para>
        /// </summary>
        ...
        /// current context will cause a <see cref="ErrorCode.NoCurrentContext"/> error.</para>
        /// </summary>
        /// <param name="interval">The minimum number of screen updates to wait for until the
        /// buffers are swapped by <see cref="SwapBuffers(Window)"/>.</param>
        /// <remarks>
